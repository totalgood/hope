...
2. script to convert lines of text (with empty lines to break) into Chatterbot Conversations json
3. train ChatterBot on Shakespear and copy sqlite DB to separate file
4. matched text (response_to: ) along side the response in small text.
5. add sentiment analysis within ChatterBot framework
6. convert to postgres on `hope` django app
7. implement madlibs hack
8. add twip predictor to ChatterBot logic
9. add tests and get them passing
